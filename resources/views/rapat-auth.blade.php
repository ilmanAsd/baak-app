            ...
            <div class="bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 overflow-hidden relative">
                ...
                <div class="relative z-10 p-10 text-center">
                    ...
                    <h2 class="text-3xl font-black text-brand-blue uppercase italic tracking-tight mb-4">
                        Akses <span class="text-brand-yellow">Keamanan</span>
                    </h2>

                    <p class="text-gray-500 text-sm font-medium leading-relaxed mb-10">
                        Halaman Agenda Rapat diproteksi dengan password keamanan. Silakan masukkan password untuk
                        melanjutkan akses.
                    </p>
                    ...
                    <form action="{{ route('rapat.auth') }}" method="POST" class="space-y-6">
                        @csrf
                        <div class="relative group">
                            ...
                            <input type="password" name="password" required placeholder="Masukkan password rapat..."
