...
@section('content')
    ...
    <section class="relative py-24 overflow-hidden bg-brand-blue">
        ...
        <div class="container relative z-10 mx-auto px-4 text-center">
            ...
            <h1 class="text-5xl md:text-6xl font-bold text-white mb-6 tracking-tight leading-tight">
                Informasi <span
                    class="text-transparent bg-clip-text bg-gradient-to-r from-brand-yellow to-yellow-200">Ijazah &
                    Transkrip</span>
            </h1>
            <p class="text-blue-100 text-lg md:text-xl font-light max-w-3xl mx-auto leading-relaxed">
                Panduan prosedur penerbitan, pengambilan ijazah, dan layanan legalisir dokumen akademik.
            </p>
        </div>
    </section>
    ...
    <div class="relative z-10 -mt-20 container mx-auto px-4 pb-24">
        ...
        <div class="bg-white rounded-3xl shadow-2xl shadow-blue-900/10 border border-gray-100 overflow-hidden">
            ...
            <div class="p-8 md:p-16 border-b border-gray-100">
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-12">
                    <div class="mb-4 md:mb-0">
                        ...
                        <p class="text-gray-500 mt-2">Syarat penerbitan ijazah dan transkrip nilai.</p>
                    </div>
                    <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div
                        ...
                        <h3 class="font-bold text-gray-800 mb-2">Dokumen Administrasi</h3>
                        <p class="text-gray-600 text-sm leading-relaxed">Telah mengumpulkan semua dokumen yang
                            dipersyaratkan oleh universitas atau fakultas (misalnya, transkrip nilai sementara, bukti bebas
                            pustaka, dan data pendukung lainnya).</p>
                    </div>
                </div>
            </div>

            <!-- 2. Alur Pengambilan Ijazah -->
            <div class="p-8 md:p-16 bg-gray-50/50 border-b border-gray-100">
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-12">
                    <div class="mb-4 md:mb-0">
                        <h2 class="text-3xl font-bold text-brand-blue">Alur Ambil Ijazah</h2>
                        <p class="text-gray-500 mt-2">Proses pengambilan ijazah kelulusan.</p>
                    </div>
                    <div
                ...
                <div class="relative max-w-4xl mx-auto">
                    ...
                    <div class="space-y-10">
                        ...
                        <div class="relative flex items-center group">
                            ...
                            <div
                                class="ml-24 bg-white p-6 rounded-xl border border-gray-100 shadow-sm w-full group-hover:shadow-md transition-shadow">
                                <h3 class="font-bold text-gray-800">Submit Tugas Akhir</h3>
                                <p class="text-gray-600 text-sm mt-1">Mengumpulkan file tugas akhir ke perpustakaan &
                                    mengisi tracer study dari JPC.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative flex items-center group">
                            ...
                            <div
                                class="ml-24 bg-white p-6 rounded-xl border border-gray-100 shadow-sm w-full group-hover:shadow-md transition-shadow">
                                <h3 class="font-bold text-gray-800">SKPI & Transkrip</h3>
                                <p class="text-gray-600 text-sm mt-1">Mengambil Transkrip Nilai akhir dan Surat Keterangan
                                    Pendamping Ijazah (SKPI) ke Fakultas masing-masing.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative flex items-center group">
                            ...
                            <div
                                ...
                                <h3 class="font-bold text-gray-800">Ambil Ijazah (BAAK)</h3>
                                <p class="text-gray-600 text-sm mt-1">Mengambil Ijazah asli di ruang Biro Administrasi
                                    Akademik & Kemahasiswaan (BAAK) dengan membawa bukti-bukti pengambilan.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- 3. Alur Legalisir Section -->
            <div class="p-8 md:p-16">
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-12">
                    <div class="mb-4 md:mb-0">
                        <h2 class="text-3xl font-bold text-brand-blue">Layanan Legalisir</h2>
                        <p class="text-gray-500 mt-2">Prosedur legalisir dokumen akademik.</p>
                    </div>
                    <div
                        class="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center text-brand-blue font-bold text-xl">
                        3</div>
                    ...
                    <div class="p-8 bg-blue-50 border border-blue-100 rounded-2xl">
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start space-x-3 text-gray-700">
                                ...
                                <span><strong>Ijazah Asli:</strong> Wajib dibawa untuk verifikasi keaslian.</span>
                            </li>
                            <li class="flex items-start space-x-3 text-gray-700">
                                <svg class="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                ...
                                <span><strong>Fotokopi Dokumen:</strong> Bawa salinan ijazah/transkrip yang ingin
                                    dilegalisir secukupnya.</span>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start space-x-3 text-gray-700">
                                <div class="px-2 py-0.5 bg-purple-200 text-purple-800 text-xs font-bold rounded mt-0.5">
                                    2020+</div>
                                <span><strong>Lulusan 2020 ke atas:</strong> Legalisir dilakukan di
                                    <strong>Fakultas</strong> masing-masing.</span>
                            </li>
                            <li class="flex items-start space-x-3 text-gray-700">
                                <div class="px-2 py-0.5 bg-brand-yellow text-brand-blue text-xs font-bold rounded mt-0.5">
                                    Old</div>
                                <span><strong>Lulusan 2019 ke bawah:</strong> Legalisir transkrip dilakukan di
                                    <strong>BAAK</strong> (Universitas).</span>
                            </li>
                        </ul>
                    </div>
                </div>
